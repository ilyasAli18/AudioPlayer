...
def play():
   ...
   while inp[0].lower() == "y":
      ...
      if file in dic:
         ...
         os.system("afplay /Users/ilyasali/desktop/audios/"+file+".mp3")
         os.system("open -a /System/Applications/Utilities/Terminal.app")
         hrs = datetime.now().strftime("%H:%M:%S")
         print(hrs+": Time it took to play",dic[file]+":",cD(hrs,hours)+".")
         print(hrs+": ----------------------------")
         hours = datetime.now().strftime("%H:%M:%S")
         print(hours+":",T,end="")
         inp = input()
...
def main():
   ...
   if not check():
      ...
      print("-"*50)
      print("An audio is already running. Try again once the audio has finished!".upper())
      print("-"*50,"\n")
      sys.exit()
main()
